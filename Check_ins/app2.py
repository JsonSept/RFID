...
<head>
    ...
    <title>User QR Code Management</title>
</head>
<body>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>{{ user[2] }}</td>
            <td>{{ user[3] }}</td>
            <td><a href="/get_qr_code/{{ user[0] }}">Download QR Code</a></td>
        </tr>
        {% endfor %}
    </table>
    ...
    <form method="POST" action="/scan">
        <label>Scanned Data (QR code string):</label>
        <input type="text" name="scanned_data" required><br>
        <button type="submit">Check Presence</button>
    </form>
</body>
</html>
"""
